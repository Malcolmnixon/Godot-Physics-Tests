...
func test_description() -> String:
	return """Checks whether the move_and_collide between sphere and concave works
	correctly."""
	
func test_name() -> String:
	return "PhysicsBody3D | testing collide sphere with concave"
...
func test_start() -> void:
	...
	collision_monitor.test_name = "move_and_collide for sphere and concave are detected correctly"
